...
<?php endif; ?>
    ...
    <!-- ====== Main Content Area ====== -->
    <main class="flex-1 flex flex-col overflow-y-auto h-[90vh]" data-event-start-date="<?php echo e($event->start_date); ?>">
    ...
    <footer class="sticky bottom-0 bg-slate-50 dark:bg-slate-950 w-full py-8 border-t border-slate-200 dark:border-slate-800 shadow-lg z-40">
        <div class="max-w-7xl mx-auto px-8 flex flex-col md:flex-row justify-between items-center gap-6">
            <div class="flex items-center gap-6">
                <a href="<?php echo e(route('event-detail', $event->e_id)); ?>" class="flex items-center gap-2 text-slate-500 hover:text-blue-900 transition-all font-medium text-xs">
...
<script src="<?php echo e(asset('js/attendance-scanner.js')); ?>"></script>

<?php /**PATH C:\AttendanceEvent\resources\views/scan-attendance.blade.php ENDPATH**/ ?>