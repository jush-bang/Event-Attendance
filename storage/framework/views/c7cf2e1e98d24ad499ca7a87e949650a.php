...
<?php endif; ?>
    ...
    <div id="toastContainer" class="fixed top-6 right-6 z-[60] max-w-sm">
        ...
        <div id="successToast" class="bg-white rounded-lg shadow-lg border-l-4 border-green-500 p-4 mb-3 flex items-start gap-3 animate-in slide-in-from-top-4 duration-300">
            ...
            <div class="flex-1">
                ...
                <p class="text-sm text-gray-600"><?php echo e(session('success')); ?></p>
            </div>
                    ...
                    <table class="w-full text-sm sm:text-base">
                        ...
                        <tbody class="divide-y divide-outline-variant/20">
                            ...
                            <tr class="hover:bg-surface-container-low transition-colors">
                                <td class="px-3 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm text-on-surface break-all sm:break-normal"><?php echo e($user->email); ?></td>
                                <td class="px-3 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm text-on-surface-variant"><?php echo e($user->role === 'admin' ? 'Administrator' : 'Scanner Personnel'); ?></td>
                                <td class="px-3 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm">
                                    <button class="editAccountBtn text-primary hover:text-primary-container font-semibold transition-colors whitespace-nowrap" data-email="<?php echo e($user->email); ?>" data-role="<?php echo e($user->role); ?>">Edit</button>
                                </td>
                            </tr>
    ...
    <div id="createAccountModal" class="hidden fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
        <div class="bg-surface-container-lowest rounded-xl shadow-lg p-6 sm:p-10 w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <form class="space-y-6" method="POST" action="<?php echo e(route('create-account.store')); ?>" id="createAccountForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <input 
                            class="block w-full pl-11 pr-4 py-3 sm:py-4 bg-surface-container-high border-none rounded-lg text-on-surface placeholder:text-outline focus:ring-2 focus:ring-primary/40 transition-all font-body text-sm <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-error <?php unset($message);
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <p class="text-error text-xs font-semibold mt-1"><?php echo e($message); ?></p>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <select 
                            class="block w-full pl-11 pr-4 py-3 sm:py-4 bg-surface-container-high border-none rounded-lg text-on-surface focus:ring-2 focus:ring-primary/40 transition-all font-body text-sm <?php $__errorArgs = ['role'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                        ...
                        >
                            ...
                            <option value="scanner" <?php echo e(old('role') === 'scanner' ? 'selected' : ''); ?>>Scanner Personnel</option>
                        </select>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <input 
                            class="block w-full pl-11 pr-14 py-3 sm:py-4 bg-surface-container-high border-none rounded-lg text-on-surface placeholder:text-outline focus:ring-2 focus:ring-primary/40 transition-all font-body text-sm <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-error <?php unset($message);
...
<?php /**PATH C:\AttendanceEvent\resources\views/create-account.blade.php ENDPATH**/ ?>